    ...
    <>
          ...
          >
            ...
            >
              <img
                src={addon.image}
                alt={addon.name}
                className="w-47 h-47 md:min-h-[188px] bg-white"
              />
            </button>
      ...
      {activeAddOn && gallery.length > 0 && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black p-4">
          <div className=" w-full max-w-8xl max-h-[95vh] overflow-hidden rounded-3xl bg-white">
            <button
              type="button"
              onClick={closeViewer}
              className="absolute right-8 top-8 z-20 rounded-full bg-black/80 px-3 py-2 text-sm font-semibold text-white hover:bg-black"
            >
              <svg
                width="14"
                height="14"
            ...
            <div className="flex h-full min-h-[70vh] flex-col items-center justify-center bg-black p-4">
              <div className="flex gap-4 w-full overflow-x-auto snap-x snap-mandatory touch-pan-x [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
